...
- **Gitea Provider** (7 files): `gitea/client.ts`, `gitea/giteaClient.ts`, `gitea/index.ts`, `gitea/issues.ts`, `gitea/pullRequests.ts`, `gitea/releases.ts`, `gitea/workflows.ts`
- **Total Provider Files** (30 files across all provider directories)
