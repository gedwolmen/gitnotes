...
private fun uniffiCheckApiChecksums(lib: IntegrityCheckingUniffiLib) {
    if (lib.uniffi_gitnotes_git2_checksum_func_add_remote() != 49298) {
        throw RuntimeException("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    }
    if (lib.uniffi_gitnotes_git2_checksum_func_backup_corrupt_repo() != 24281) {
        throw RuntimeException("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    }
    if (lib.uniffi_gitnotes_git2_checksum_func_checkout_branch() != 44161) {
        throw RuntimeException("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    }
    if (lib.uniffi_gitnotes_git2_checksum_func_checkout_commit() != 46985) {
        throw RuntimeException("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    }
    if (lib.uniffi_gitnotes_git2_checksum_func_clear_credential() != 31828) {
        throw RuntimeException("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    }
    if (lib.uniffi_gitnotes_git2_checksum_func_clone_repo_with_progress() != 28853) {
        throw RuntimeException("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    }
    if (lib.uniffi_gitnotes_git2_checksum_func_commit_changes() != 51804) {
        throw RuntimeException("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    }
    if (lib.uniffi_gitnotes_git2_checksum_func_commit_diff() != 37128) {
        throw RuntimeException("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    }
    if (lib.uniffi_gitnotes_git2_checksum_func_create_branch() != 34002) {
        throw RuntimeException("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    }
    if (lib.uniffi_gitnotes_git2_checksum_func_delete_branch() != 48935) {
        throw RuntimeException("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    }
    if (lib.uniffi_gitnotes_git2_checksum_func_diff_all() != 26660) {
        throw RuntimeException("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    }
    if (lib.uniffi_gitnotes_git2_checksum_func_diff_file() != 29484) {
        throw RuntimeException("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    }
    if (lib.uniffi_gitnotes_git2_checksum_func_discard_files() != 61910) {
        throw RuntimeException("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    }
    if (lib.uniffi_gitnotes_git2_checksum_func_engine_name() != 7531) {
        throw RuntimeException("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    }
    if (lib.uniffi_gitnotes_git2_checksum_func_fetch_repo_with_progress() != 53247) {
        throw RuntimeException("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    }
    if (lib.uniffi_gitnotes_git2_checksum_func_generate_ssh_key() != 21791) {
        throw RuntimeException("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    }
    if (lib.uniffi_gitnotes_git2_checksum_func_get_conflict_blobs() != 56863) {
        throw RuntimeException("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    }
    if (lib.uniffi_gitnotes_git2_checksum_func_get_conflicts() != 61175) {
        throw RuntimeException("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    }
    if (lib.uniffi_gitnotes_git2_checksum_func_get_credential() != 31622) {
        throw RuntimeException("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    }
    if (lib.uniffi_gitnotes_git2_checksum_func_init_repo() != 56999) {
        throw RuntimeException("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    }
    if (lib.uniffi_gitnotes_git2_checksum_func_is_repo_locked() != 16374) {
        throw RuntimeException("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    }
    if (lib.uniffi_gitnotes_git2_checksum_func_list_branches() != 65035) {
        throw RuntimeException("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    }
    if (lib.uniffi_gitnotes_git2_checksum_func_list_remotes() != 46032) {
        throw RuntimeException("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    }
    if (lib.uniffi_gitnotes_git2_checksum_func_list_statuses() != 48613) {
        throw RuntimeException("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    }
    if (lib.uniffi_gitnotes_git2_checksum_func_mark_conflict_resolved() != 43449) {
        throw RuntimeException("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    }
    if (lib.uniffi_gitnotes_git2_checksum_func_pull_repo() != 2596) {
        throw RuntimeException("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    }
    if (lib.uniffi_gitnotes_git2_checksum_func_push_repo() != 37905) {
        throw RuntimeException("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    }
    if (lib.uniffi_gitnotes_git2_checksum_func_push_repo_with_integrate() != 54095) {
        throw RuntimeException("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    }
    if (lib.uniffi_gitnotes_git2_checksum_func_recent_commits() != 41752) {
        throw RuntimeException("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    }
    if (lib.uniffi_gitnotes_git2_checksum_func_remove_paths() != 44845) {
        throw RuntimeException("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    }
    if (lib.uniffi_gitnotes_git2_checksum_func_remove_remote() != 42646) {
        throw RuntimeException("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    }
    if (lib.uniffi_gitnotes_git2_checksum_func_remove_repo() != 40372) {
        throw RuntimeException("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    }
    if (lib.uniffi_gitnotes_git2_checksum_func_rename_branch() != 14093) {
        throw RuntimeException("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    }
    if (lib.uniffi_gitnotes_git2_checksum_func_repair_repo() != 10743) {
        throw RuntimeException("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    }
    if (lib.uniffi_gitnotes_git2_checksum_func_repo_info() != 60049) {
        throw RuntimeException("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    }
    if (lib.uniffi_gitnotes_git2_checksum_func_repo_status() != 3675) {
        throw RuntimeException("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    }
    if (lib.uniffi_gitnotes_git2_checksum_func_reset_soft() != 64004) {
        throw RuntimeException("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    }
    if (lib.uniffi_gitnotes_git2_checksum_func_resolve_conflict() != 33234) {
        throw RuntimeException("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    }
    if (lib.uniffi_gitnotes_git2_checksum_func_revert_commit() != 53129) {
        throw RuntimeException("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    }
    if (lib.uniffi_gitnotes_git2_checksum_func_set_credential() != 42725) {
        throw RuntimeException("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    }
    if (lib.uniffi_gitnotes_git2_checksum_func_set_remote_url() != 54340) {
        throw RuntimeException("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    }
    if (lib.uniffi_gitnotes_git2_checksum_func_stage_file_lines() != 26625) {
        throw RuntimeException("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    }
    if (lib.uniffi_gitnotes_git2_checksum_func_stage_paths() != 46672) {
        throw RuntimeException("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    }
    if (lib.uniffi_gitnotes_git2_checksum_func_unstage_paths() != 21659) {
        throw RuntimeException("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    }
    if (lib.uniffi_gitnotes_git2_checksum_func_version() != 15512) {
        throw RuntimeException("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    }
    if (lib.uniffi_gitnotes_git2_checksum_method_progresslistener_on_progress() != 32628) {
        throw RuntimeException("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    }
}
